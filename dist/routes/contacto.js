...
const contactoRoutes = express_1.Router();
//Obtener contactos
contactoRoutes.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
//Crear contactos
contactoRoutes.post('/', [autenticacion_1.verificaToken], (req, res) => {
    const body = req.body;
...
exports.default = contactoRoutes;
